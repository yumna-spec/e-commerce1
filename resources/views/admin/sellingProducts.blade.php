...
<div class="container mt-4">
    <div class="row align-items-end"> 
        ...
        <div class="col-md-5">
           <form action="{{ route('product.searchbar') }}" method="GET" class="d-flex align-items-center gap-3">
            <div class="input-group bg-white border-radius-lg p-1 shadow-sm border">
                    
                    <input value="{{ request('search') }}" name="search" placeholder="Search..." class="form-control border-0 ps-2" type="text">
                </div>
 ...
 <a href="{{ route('product.latest') }}" class="btn btn-sm btn-white me-3 text-dark mb-0 d-flex align-items-center">
                ...
                <a href="{{ route('product.topselling') }}" class="btn btn-sm btn-white me-3 text-dark mb-0 d-flex align-items-center">
                 ...
                 <a href="{{ route('product.lessselling') }}" class="btn btn-sm btn-white me-3 text-dark mb-0 d-flex align-items-center">
                   Less Selling
                </a>
              </div>
            </div>
                  ...
                  <tbody>
                    ...
                    @foreach($orderItems as $item)
                     <tr>
                      ...
                      <td>
                        <p class="text-sm font-weight-bold mb-0 text-success">Total Sold: {{ $item->total_sold }}</p>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        ...
                        <a href="{{ route('product.edit', $item->product_id) }}" class="btn btn-link text-dark px-2 mb-0" data-bs-toggle="tooltip" title="Edit">
                          <i class="material-symbols-rounded text-sm me-1">edit</i> Edit
                        </a>

                        <form method="POST" action="{{ route('admin.product.delete', $item->product_id) }}" class="d-inline-block">
                            @csrf
                            @method('DELETE')
                        ...
                        <p class="text-sm font-weight-bold mb-0 text-success">${{ $item->product->price }}</p>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        ...
                        <form method="POST" action="{{ route('admin.product.delete', $item->product->id) }}" class="d-inline-block">
                            @csrf
                            @method('DELETE')
