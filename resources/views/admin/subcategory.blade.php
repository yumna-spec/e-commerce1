                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                            <a href="{{ route('productbysubcategory.index', $category->id) }}" class="btn btn-sm btn-outline-dark mb-0">
                                view products
                            </a>
                        </td>
                        ...
                        <td class="align-middle text-center">
                                <a href="{{ route('productsub.add', $category->id) }}" class="btn btn-sm btn-outline-dark mb-0">
add product                                </a>
                            </td>
